...
#define LAYOUT_4x6_11_base( \
        ...
        K30, K31, K32, K33, K34, K35,   K38, K39, K3A, K3B, K3C, K3D, \
            ...
            K30,        SFT_T(K31), K32, K33,        K34,        K35,        KC_NO, KC_NO,    KC_NO, KC_NO, K38,        K39,        K3A,        K3B,              RSFT_T(K3C), K3D,        \
...
#define LAYOUT_4x6_11_layer( \
        ...
        K30, K31, K32, K33, K34, K35,   K38, K39, K3A, K3B, K3C, K3D, \
            ...
            K30,     K31,     K32, K33, K34, K35, KC_NO, KC_NO,    KC_NO, KC_NO, K38, K39, K3A,     K3B,     K3C,     K3D, \
            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  K43, K44, K45,    K48,   K49,   K4A, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS  \
    )
