...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BONEM] = LAYOUT_kyria_hrm_wrapper(
        _____________________BONE_M_L1____________________6_, _____________________BONE_M_R1____________________6_,
        _____________________BONE_M_L2____________________6_, _____________________BONE_M_R2____________________6_,
        _____________________BONE_M_L3____________________6_, _____________________BONE_M_R3____________________6_,
                 ________________________________________THUMB_5_5____________________________________10_
    ),
