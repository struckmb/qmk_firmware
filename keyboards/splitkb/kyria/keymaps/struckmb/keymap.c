...
#define LAYOUT_kyria_base( \
  ...
  LAYOUT_wrapper( \
      ...
      OSM_SFT, SFT_T(K21), K22, K23, ALT_T(K24), K25, KC_NO, KC_NO,      KC_NO, CW_TOGG, K26, ALT_T(K27), K28, K29, RSFT_T(K2A), OSM_SFT, \
                                   KC_PGUP, KC_PGDN, K33, K34, K35,      K36, K37, K38, OSM_GUI, KC_NO \
    )
