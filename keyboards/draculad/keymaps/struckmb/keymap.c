...
#define DE_AUML KC_QUOT
#define DE_OUML KC_SCLN
#define DE_UUML KC_LBRC
#define DE_SUML KC_MINS
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] =  LAYOUT(
        ...
        KC_A, LALT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), LGUI_T(KC_G),                            LGUI_T(KC_H),RSFT_T(KC_J),RCTL_T(KC_K),LALT_T(KC_L),    DE_OUML,
        LSFT_T(KC_Z), KC_X,         KC_C,         KC_V,         KC_B,                            KC_N,   KC_M,     KC_COMM,      KC_DOT, RSFT_T(DE_SUML),
                                                 KC_MUTE,                                      TG(_ADJ),
