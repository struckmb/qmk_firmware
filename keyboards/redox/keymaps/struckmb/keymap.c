 ...
 */
  [_NAV] = LAYOUT( // BN4_4 is undefined
     ...
     SY_ATAB, KC_PGUP, KC_BSPC, KC_UP,   KC_DEL,  KC_INS,  _______,                           _______, DE_ASTR, DE_7,    DE_8,    DE_9,    DE_SLSH, DE_SCLN,
     _______, KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT,KC_END,  _______,                           _______, DE_0,    DE_4,    DE_5,    DE_6,    DE_DOT,  DE_COLN,
     _______, KC_ESC,  SY_UNDO, SY_REDO, KC_ENT,  KC_PGDN, KC_WHOM, KC_NUM,          _______, _______, DE_PLUS, DE_1,    DE_2,    DE_3,    DE_COMM, DE_MINS,
     _______ ,_______, SY_CUT,  SY_RYDO,     KC_TRNS,      KC_WBAK, KC_WFWD,         _______, _______,     KC_TRNS,      _______, _______, _______, _______
  ),
