...
#define LAYOUT_redox_hrm_wrapper(...)       LAYOUT_4x6_11_base(__VA_ARGS__)
#define LAYOUT_redox_wrapper(...)           LAYOUT_4x6_11_layer(__VA_ARGS__)
// clang-format on

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
#ifdef QWERTZ_ENABLE
    [_QWERTZ] = LAYOUT_redox_hrm_wrapper(
...
#endif // QWERTZ_ENABLE
#ifdef BONE_ENABLE
    [_BONE] = LAYOUT_redox_hrm_wrapper(
        _____________________NUMBER_L0____________________6_, _____________________NUMBER_R0____________________6_,
    ...
    [_LILYPOND] = LAYOUT_redox_hrm_wrapper(
        _____________________NUMBER_L0____________________6_, _____________________NUMBER_R0____________________6_,
